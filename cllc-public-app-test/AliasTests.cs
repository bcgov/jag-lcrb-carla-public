...
{
    public class AliasTests : ApiIntegrationTestBaseWithLogin
    {
        public AliasTests(CustomWebApplicationFactory<Startup> factory)
          : base(factory)
        { }
        ...
        public async System.Threading.Tasks.Task TestNoAccessToAnonymousUser()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "/api/alias/by-contactid/" + id);
