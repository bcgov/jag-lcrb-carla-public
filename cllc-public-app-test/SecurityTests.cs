...
namespace Gov.Lclb.Cllb.Public.Test
{
	public class SecurityTests : ApiIntegrationTestBaseWithLogin
	{
		...
		public async System.Threading.Tasks.Task UserCantAccessAnotherUsersShareholders()
		{
			...
			ViewModels.AdoxioLegalEntity dos1 = await SecurityHelper.CreateDirectorOrShareholder(_client, user1, true, false, false);
			Assert.NotNull(dos1);
			ViewModels.AdoxioLegalEntity dos2 = await SecurityHelper.CreateDirectorOrShareholder(_client, user1, false, true, false);
			Assert.NotNull(dos2);
			ViewModels.AdoxioLegalEntity dos3 = await SecurityHelper.CreateDirectorOrShareholder(_client, user1, false, false, true);
			Assert.NotNull(dos3);
            // ***
        ...
        public async System.Threading.Tasks.Task UserCantAccessAnotherUsersAccountAttachments()
        {
			...
			// *** upload some Account attachments
        ...
        public async System.Threading.Tasks.Task UserCantAccessAnotherUsersApplicationAttachments()
        {
            ...
            // *** create some license application attachments
            // TODO
            // ***
            ...
            // *** as user 2, try to access license application attachments of account 1
            // TODO
            // ***
