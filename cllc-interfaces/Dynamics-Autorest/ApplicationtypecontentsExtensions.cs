...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class ApplicationtypecontentsExtensions
    {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationtypecontentCollection> GetAsync(this IApplicationtypecontents operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationtypecontentCollection> GetWithHttpMessages(this IApplicationtypecontents operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
