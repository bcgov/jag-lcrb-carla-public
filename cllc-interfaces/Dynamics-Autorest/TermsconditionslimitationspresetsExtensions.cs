...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class TermsconditionslimitationspresetsExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<TermsconditionslimitationspresetsGetResponseModel> GetWithHttpMessages(this ITermsconditionslimitationspresets operations, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
