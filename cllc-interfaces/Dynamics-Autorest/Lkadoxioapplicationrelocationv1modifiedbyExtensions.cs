...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationrelocationv1modifiedby.
    /// </summary>
    public static partial class Lkadoxioapplicationrelocationv1modifiedbyExtensions
    {
            /// <summary>
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationrelocationv1 ModifiedbyByKey(this ILkadoxioapplicationrelocationv1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationrelocationv1> ModifiedbyByKeyAsync(this ILkadoxioapplicationrelocationv1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationrelocationv1> ModifiedbyByKeyWithHttpMessages(this ILkadoxioapplicationrelocationv1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
