...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// </summary>
    public partial interface IAuditlogrequests
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMadoxioAuditlogrequest>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMadoxioAuditlogrequest body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
