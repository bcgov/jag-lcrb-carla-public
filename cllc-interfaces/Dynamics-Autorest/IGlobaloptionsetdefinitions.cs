...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public partial interface IGlobaloptionsetdefinitions
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMOptionSetMetadataBase>> GetByKeyGlobalOptionSetDefinitionsByKeyWithHttpMessagesAsync(System.Guid metadataId, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> UpdateGlobalOptionSetDefinitionsByKeyWithHttpMessagesAsync(System.Guid metadataId, MicrosoftDynamicsCRMOptionSetMetadataBase body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when the operation returned an invalid status code
        /// </exception>
        Task<HttpOperationResponse> DeleteGlobalOptionSetDefinitionsByKeyWithHttpMessagesAsync(System.Guid metadataId, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
