...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationcrsbpfv4activestageid.
    /// </summary>
    public static partial class Lkadoxioapplicationcrsbpfv4activestageidExtensions
    {
            /// <summary>
            /// Get lk_adoxio_applicationcrsbpfv4_activestageid from processstages
            /// </summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4Collection Get(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4Collection> GetAsync(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4Collection> GetWithHttpMessages(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4 ActivestageidByKey(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4> ActivestageidByKeyAsync(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationcrsbpfv4> ActivestageidByKeyWithHttpMessages(this ILkadoxioapplicationcrsbpfv4activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
