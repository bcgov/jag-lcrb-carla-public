...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class InvoiceExtensions
    {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMinvoice> GetAsync(this IInvoice operations, string adoxioContraventionid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMinvoice> GetWithHttpMessages(this IInvoice operations, string adoxioContraventionid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
