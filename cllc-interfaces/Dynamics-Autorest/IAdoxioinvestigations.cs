...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// </summary>
    public partial interface IAdoxioinvestigations
    {
        /// <summary>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMadoxioInvestigation>> InvestigationsByKeyWithHttpMessagesAsync(System.Guid adoxioInvestigationid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> InvestigationsByKey1WithHttpMessagesAsync(System.Guid adoxioInvestigationid, MicrosoftDynamicsCRMadoxioInvestigation body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when the operation returned an invalid status code
        /// </exception>
        Task<HttpOperationResponse> InvestigationsByKey2WithHttpMessagesAsync(System.Guid adoxioInvestigationid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
