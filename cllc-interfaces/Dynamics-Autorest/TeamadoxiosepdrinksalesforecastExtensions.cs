...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Teamadoxiosepdrinksalesforecast.
    /// </summary>
    public static partial class TeamadoxiosepdrinksalesforecastExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSepdrinksalesforecastCollection Get(this ITeamadoxiosepdrinksalesforecast operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioSepdrinksalesforecastCollection> GetWithHttpMessages(this ITeamadoxiosepdrinksalesforecast operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioSepdrinksalesforecast> SepdrinksalesforecastByKeyAsync(this ITeamadoxiosepdrinksalesforecast operations, string ownerid, string adoxioSepdrinksalesforecastid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioSepdrinksalesforecast> SepdrinksalesforecastByKeyWithHttpMessages(this ITeamadoxiosepdrinksalesforecast operations, string ownerid, string adoxioSepdrinksalesforecastid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
