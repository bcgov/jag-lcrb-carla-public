...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiosepdrinksalesforecast.
    /// </summary>
    public static partial class ObjectidadoxiosepdrinksalesforecastExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSepdrinksalesforecast Get(this IObjectidadoxiosepdrinksalesforecast operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioSepdrinksalesforecast> GetAsync(this IObjectidadoxiosepdrinksalesforecast operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
