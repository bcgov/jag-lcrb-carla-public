...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationrelocationv1processid.
    /// </summary>
    public static partial class Lkadoxioapplicationrelocationv1processidExtensions
    {
            /// <summary>
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationrelocationv1 ProcessidByKey(this ILkadoxioapplicationrelocationv1processid operations, string workflowid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationrelocationv1> ProcessidByKeyWithHttpMessages(this ILkadoxioapplicationrelocationv1processid operations, string workflowid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
