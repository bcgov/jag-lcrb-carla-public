...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationlicenseechangesv10modifiedby.
    /// </summary>
    public static partial class Lkadoxioapplicationlicenseechangesv10modifiedbyExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationlicenseechangesv10Collection Get(this ILkadoxioapplicationlicenseechangesv10modifiedby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationlicenseechangesv10Collection> GetAsync(this ILkadoxioapplicationlicenseechangesv10modifiedby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationlicenseechangesv10 ModifiedbyByKey(this ILkadoxioapplicationlicenseechangesv10modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
