...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public partial interface IAdoxiotiedhouseassociations
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMadoxioTiedhouseassociationCollection>> GetWithHttpMessagesAsync(IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> TiedhouseassociationsByKey1WithHttpMessagesAsync(System.Guid adoxioTiedhouseassociationid, MicrosoftDynamicsCRMadoxioTiedhouseassociation body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when the operation returned an invalid status code
        /// </exception>
        Task<HttpOperationResponse> TiedhouseassociationsByKey2WithHttpMessagesAsync(System.Guid adoxioTiedhouseassociationid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
