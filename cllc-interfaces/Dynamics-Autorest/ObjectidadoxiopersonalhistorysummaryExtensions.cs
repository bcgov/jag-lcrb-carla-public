...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiopersonalhistorysummary.
    /// </summary>
    public static partial class ObjectidadoxiopersonalhistorysummaryExtensions
    {
            /// <summary>
            /// Get objectid_adoxio_personalhistorysummary from
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioPersonalhistorysummary Get(this IObjectidadoxiopersonalhistorysummary operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
