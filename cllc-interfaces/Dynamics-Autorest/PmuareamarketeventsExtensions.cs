...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Pmuareamarketevents.
    /// </summary>
    public static partial class PmuareamarketeventsExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioEventCollection> GetWithHttpMessages(this IPmuareamarketevents operations, string adoxioPmuareaid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioEvent MarketeventsByKey(this IPmuareamarketevents operations, string adoxioPmuareaid, string adoxioEventid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
                return operations.MarketeventsByKeyAsync(adoxioPmuareaid, adoxioEventid, select, expand).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.MarketeventsByKeyWithHttpMessagesAsync(adoxioPmuareaid, adoxioEventid, select, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioEvent> MarketeventsByKeyWithHttpMessages(this IPmuareamarketevents operations, string adoxioPmuareaid, string adoxioEventid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
                return operations.MarketeventsByKeyWithHttpMessagesAsync(adoxioPmuareaid, adoxioEventid, select, expand, customHeaders, CancellationToken.None).ConfigureAwait(false).GetAwaiter().GetResult();
            }
