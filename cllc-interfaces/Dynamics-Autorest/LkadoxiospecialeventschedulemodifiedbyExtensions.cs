...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxiospecialeventschedulemodifiedby.
    /// </summary>
    public static partial class LkadoxiospecialeventschedulemodifiedbyExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSpecialeventscheduleCollection Get(this ILkadoxiospecialeventschedulemodifiedby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSpecialeventschedule ModifiedbyByKey(this ILkadoxiospecialeventschedulemodifiedby operations, string ownerid, string adoxioSpecialeventscheduleid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
                return operations.ModifiedbyByKeyAsync(ownerid, adoxioSpecialeventscheduleid, select, expand).GetAwaiter().GetResult();
            }
            ...
            {
                using (var _result = await operations.ModifiedbyByKeyWithHttpMessagesAsync(ownerid, adoxioSpecialeventscheduleid, select, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioSpecialeventschedule> ModifiedbyByKeyWithHttpMessages(this ILkadoxiospecialeventschedulemodifiedby operations, string ownerid, string adoxioSpecialeventscheduleid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
                return operations.ModifiedbyByKeyWithHttpMessagesAsync(ownerid, adoxioSpecialeventscheduleid, select, expand, customHeaders, CancellationToken.None).ConfigureAwait(false).GetAwaiter().GetResult();
            }
