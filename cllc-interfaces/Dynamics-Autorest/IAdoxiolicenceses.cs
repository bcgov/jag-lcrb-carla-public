...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// </summary>
    public partial interface IAdoxiolicenceses
    {
        /// <summary>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMadoxioLicences>> LicencesesByKeyWithHttpMessagesAsync(System.Guid adoxioLicencesid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> LicencesesByKey1WithHttpMessagesAsync(System.Guid adoxioLicencesid, MicrosoftDynamicsCRMadoxioLicences body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when the operation returned an invalid status code
        /// </exception>
        Task<HttpOperationResponse> LicencesesByKey2WithHttpMessagesAsync(System.Guid adoxioLicencesid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
