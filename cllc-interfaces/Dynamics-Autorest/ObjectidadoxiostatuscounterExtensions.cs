...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiostatuscounter.
    /// </summary>
    public static partial class ObjectidadoxiostatuscounterExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioStatuscounter Get(this IObjectidadoxiostatuscounter operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioStatuscounter> GetAsync(this IObjectidadoxiostatuscounter operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioStatuscounter> GetWithHttpMessages(this IObjectidadoxiostatuscounter operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
