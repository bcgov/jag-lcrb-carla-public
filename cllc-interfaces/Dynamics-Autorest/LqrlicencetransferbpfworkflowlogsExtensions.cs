...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lqrlicencetransferbpfworkflowlogs.
    /// </summary>
    public static partial class LqrlicencetransferbpfworkflowlogsExtensions
    {
            /// <summary>
            /// Get adoxio_lqrlicencetransferbpf_WorkflowLogs from
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMworkflowlogCollection> GetAsync(this ILqrlicencetransferbpfworkflowlogs operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMworkflowlogCollection> GetWithHttpMessages(this ILqrlicencetransferbpfworkflowlogs operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMworkflowlog WorkflowLogsByKey(this ILqrlicencetransferbpfworkflowlogs operations, string businessprocessflowinstanceid, string workflowlogid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMworkflowlog> WorkflowLogsByKeyAsync(this ILqrlicencetransferbpfworkflowlogs operations, string businessprocessflowinstanceid, string workflowlogid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
