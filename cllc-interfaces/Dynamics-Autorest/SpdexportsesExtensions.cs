...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class SpdexportsesExtensions
    {
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSpdexportsCollection Get(this ISpdexportses operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioSpdexports> CreateWithHttpMessages(this ISpdexportses operations, MicrosoftDynamicsCRMadoxioSpdexports body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioSpdexports> GetByKeyWithHttpMessages(this ISpdexportses operations, string adoxioSpdexportsid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse UpdateWithHttpMessages(this ISpdexportses operations, string adoxioSpdexportsid, MicrosoftDynamicsCRMadoxioSpdexports body, Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse DeleteWithHttpMessages(this ISpdexportses operations, string adoxioSpdexportsid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
