...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public partial interface IEventschedules
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMadoxioEventschedule>> SchedulesByKeyWithHttpMessagesAsync(string adoxioEventid, string adoxioEventscheduleid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
