...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationstructurechangev1activestageid.
    /// </summary>
    public static partial class Lkadoxioapplicationstructurechangev1activestageidExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1Collection> GetAsync(this ILkadoxioapplicationstructurechangev1activestageid operations, string processstageid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationstructurechangev1 ActivestageidByKey(this ILkadoxioapplicationstructurechangev1activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1> ActivestageidByKeyAsync(this ILkadoxioapplicationstructurechangev1activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1> ActivestageidByKeyWithHttpMessages(this ILkadoxioapplicationstructurechangev1activestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
