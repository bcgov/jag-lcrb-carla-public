...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class AreaExtensions
    {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioArea> GetAsync(this IArea operations, string adoxioInspectorreportid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioArea> GetWithHttpMessages(this IArea operations, string adoxioInspectorreportid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
