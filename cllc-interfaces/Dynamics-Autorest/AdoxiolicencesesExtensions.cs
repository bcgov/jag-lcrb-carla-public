...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class AdoxiolicencesesExtensions
    {
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioLicencesCollection Get(this IAdoxiolicenceses operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioLicencesCollection> GetWithHttpMessages(this IAdoxiolicenceses operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioLicences GetByKey(this IAdoxiolicenceses operations, string adoxioLicencesid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioLicences> GetByKeyAsync(this IAdoxiolicenceses operations, string adoxioLicencesid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioLicences> GetByKeyWithHttpMessages(this IAdoxiolicenceses operations, string adoxioLicencesid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// New property values
            /// </param>
            public static void Update(this IAdoxiolicenceses operations, string adoxioLicencesid, MicrosoftDynamicsCRMadoxioLicences body)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task UpdateAsync(this IAdoxiolicenceses operations, string adoxioLicencesid, MicrosoftDynamicsCRMadoxioLicences body, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse UpdateWithHttpMessages(this IAdoxiolicenceses operations, string adoxioLicencesid, MicrosoftDynamicsCRMadoxioLicences body, Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// ETag
            /// </param>
            public static void Delete(this IAdoxiolicenceses operations, string adoxioLicencesid, string ifMatch = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IAdoxiolicenceses operations, string adoxioLicencesid, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse DeleteWithHttpMessages(this IAdoxiolicenceses operations, string adoxioLicencesid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
