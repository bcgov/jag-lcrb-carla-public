...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class InspectorcommentsrollupsExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioInspectorcommentsrollupCollection> GetWithHttpMessages(this IInspectorcommentsrollups operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioInspectorcommentsrollup> CreateWithHttpMessages(this IInspectorcommentsrollups operations, MicrosoftDynamicsCRMadoxioInspectorcommentsrollup body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioInspectorcommentsrollup> GetByKeyWithHttpMessages(this IInspectorcommentsrollups operations, string adoxioInspectorcommentsrollupid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse UpdateWithHttpMessages(this IInspectorcommentsrollups operations, string adoxioInspectorcommentsrollupid, MicrosoftDynamicsCRMadoxioInspectorcommentsrollup body, Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse DeleteWithHttpMessages(this IInspectorcommentsrollups operations, string adoxioInspectorcommentsrollupid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
