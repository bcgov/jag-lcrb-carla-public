...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class InspectorcommentsrollupsExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<InspectorcommentsrollupsGetResponseModel> GetWithHttpMessages(this IInspectorcommentsrollups operations, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
