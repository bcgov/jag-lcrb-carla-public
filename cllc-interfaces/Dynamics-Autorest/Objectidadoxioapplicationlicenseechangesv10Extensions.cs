...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxioapplicationlicenseechangesv10.
    /// </summary>
    public static partial class Objectidadoxioapplicationlicenseechangesv10Extensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationlicenseechangesv10 Get(this IObjectidadoxioapplicationlicenseechangesv10 operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
