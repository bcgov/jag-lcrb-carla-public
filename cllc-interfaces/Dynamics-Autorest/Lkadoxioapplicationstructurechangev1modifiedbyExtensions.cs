...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationstructurechangev1modifiedby.
    /// </summary>
    public static partial class Lkadoxioapplicationstructurechangev1modifiedbyExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1Collection> GetAsync(this ILkadoxioapplicationstructurechangev1modifiedby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationstructurechangev1 ModifiedbyByKey(this ILkadoxioapplicationstructurechangev1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1> ModifiedbyByKeyAsync(this ILkadoxioapplicationstructurechangev1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationstructurechangev1> ModifiedbyByKeyWithHttpMessages(this ILkadoxioapplicationstructurechangev1modifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
