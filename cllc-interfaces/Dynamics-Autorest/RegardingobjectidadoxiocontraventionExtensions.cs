...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class RegardingobjectidadoxiocontraventionExtensions
    {
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioContravention Get(this IRegardingobjectidadoxiocontravention operations, string sharepointdocumentlocationid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
