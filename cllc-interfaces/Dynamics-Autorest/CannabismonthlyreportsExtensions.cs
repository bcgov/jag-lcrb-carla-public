...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class CannabismonthlyreportsExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioCannabismonthlyreportCollection> GetWithHttpMessages(this ICannabismonthlyreports operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
