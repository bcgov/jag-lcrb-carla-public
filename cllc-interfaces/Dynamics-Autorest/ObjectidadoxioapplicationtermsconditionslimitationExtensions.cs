...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxioapplicationtermsconditionslimitation.
    /// </summary>
    public static partial class ObjectidadoxioapplicationtermsconditionslimitationExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationtermsconditionslimitation Get(this IObjectidadoxioapplicationtermsconditionslimitation operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
