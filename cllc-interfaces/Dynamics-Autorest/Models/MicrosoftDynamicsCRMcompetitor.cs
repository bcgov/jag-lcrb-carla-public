...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcompetitor
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMcompetitor(string _transactioncurrencyidValue = default(string), int? reportingyear = default(int?), string address2County = default(string), string address2Line1 = default(string), string yominame = default(string), string _modifiedbyValue = default(string), string address2Stateorprovince = default(string), string name = default(string), string _modifiedonbehalfbyValue = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), int? address2Utcoffset = default(int?), int? reportingquarter = default(int?), string _createdonbehalfbyValue = default(string), string address1Name = default(string), string _createdbyValue = default(string), string address1Composite = default(string), string address1Line3 = default(string), string address2Upszone = default(string), decimal? exchangerate = default(decimal?), int? importsequencenumber = default(int?), long? entityimageTimestamp = default(long?), string threats = default(string), string address1Telephone3 = default(string), decimal? reportedrevenueBase = default(decimal?), string keyproduct = default(string), string tickersymbol = default(string), string competitorid = default(string), string versionnumber = default(string), string address2Name = default(string), decimal? address2Latitude = default(decimal?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), decimal? address2Longitude = default(decimal?), int? address1Utcoffset = default(int?), string address1City = default(string), string _organizationidValue = default(string), string address2Postofficebox = default(string), string address1Stateorprovince = default(string), string stockexchange = default(string), int? address1Addresstypecode = default(int?), string address1Upszone = default(string), decimal? winpercentage = default(decimal?), decimal? reportedrevenue = default(decimal?), string strengths = default(string), string opportunities = default(string), byte[] entityimage = default(byte[]), string address1Telephone1 = default(string), string address1County = default(string), string address2Line3 = default(string), string address1Telephone2 = default(string), string address1Line2 = default(string), string address2Telephone1 = default(string), string address2Composite = default(string), int? address2Shippingmethodcode = default(int?), string entityimageUrl = default(string), string address2Telephone3 = default(string), string entityimageid = default(string), string address1Postalcode = default(string), string address2City = default(string), string address2Fax = default(string), int? utcconversiontimezonecode = default(int?), string stageid = default(string), string websiteurl = default(string), string address1Fax = default(string), string address1Postofficebox = default(string), string overview = default(string), string address1Country = default(string), decimal? address1Latitude = default(decimal?), string address1Addressid = default(string), decimal? address1Longitude = default(decimal?), string address2Postalcode = default(string), int? address2Addresstypecode = default(int?), string weaknesses = default(string), int? address1Shippingmethodcode = default(int?), string traversedpath = default(string), string address2Telephone2 = default(string), string address2Addressid = default(string), string address2Country = default(string), string referenceinfourl = default(string), string address2Line2 = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), int? timezoneruleversionnumber = default(int?), string address1Line1 = default(string), string processid = default(string), IList<MicrosoftDynamicsCRMpostregarding> competitorPostRegardings = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMpostfollow> competitorPostFollows = default(IList<MicrosoftDynamicsCRMpostfollow>), IList<MicrosoftDynamicsCRMsalesliterature> competitorsalesliteratureAssociation = default(IList<MicrosoftDynamicsCRMsalesliterature>), IList<MicrosoftDynamicsCRMproduct> competitorproductAssociation = default(IList<MicrosoftDynamicsCRMproduct>), IList<MicrosoftDynamicsCRMopportunity> opportunitycompetitorsAssociation = default(IList<MicrosoftDynamicsCRMopportunity>), IList<MicrosoftDynamicsCRMteam> competitorTeams = default(IList<MicrosoftDynamicsCRMteam>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> competitorMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMsyncerror> competitorSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMduplicaterecord> competitorDuplicateBaseRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), MicrosoftDynamicsCRMprocessstage stageidProcessstage = default(MicrosoftDynamicsCRMprocessstage), IList<MicrosoftDynamicsCRMconnection> competitorConnections2 = default(IList<MicrosoftDynamicsCRMconnection>), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> competitorPrincipalobjectattributeaccess = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMannotation> competitorAnnotation = default(IList<MicrosoftDynamicsCRMannotation>), IList<MicrosoftDynamicsCRMconnection> competitorConnections1 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMcompetitoraddress> competitorAddresses = default(IList<MicrosoftDynamicsCRMcompetitoraddress>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMasyncoperation> competitorAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMopportunityclose> competitorOpportunityActivities = default(IList<MicrosoftDynamicsCRMopportunityclose>), IList<MicrosoftDynamicsCRMduplicaterecord> competitorDuplicateMatchingRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMbulkdeletefailure> competitorBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprocesssession> competitorProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMlead> leadcompetitorsAssociation = default(IList<MicrosoftDynamicsCRMlead>))
        {
