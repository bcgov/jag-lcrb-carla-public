...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcustomcontrolresource
    {
        ...
        /// MicrosoftDynamicsCRMcustomcontrolresource class.
        /// </summary>
        public MicrosoftDynamicsCRMcustomcontrolresource(string _createdbyValue = default(string), string _createdonbehalfbyValue = default(string), string _modifiedbyValue = default(string), string _modifiedonbehalfbyValue = default(string), string _organizationidValue = default(string), int? componentstate = default(int?), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), string customcontrolid = default(string), MicrosoftDynamicsCRMcustomcontrol customcontrolidCustomcontrol = default(MicrosoftDynamicsCRMcustomcontrol), string customcontrolresourceid = default(string), string customcontrolresourceidunique = default(string), string introducedversion = default(string), bool? ismanaged = default(bool?), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), string name = default(string), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string solutionid = default(string), string version = default(string), object versionnumber = default(object), string versionrequirement = default(string), string webresourceid = default(string))
        {
