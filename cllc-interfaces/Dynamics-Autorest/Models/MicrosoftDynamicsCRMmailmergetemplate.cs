...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMmailmergetemplate
    {
        ...
        public MicrosoftDynamicsCRMmailmergetemplate(int? timezoneruleversionnumber = default(int?), int? componentstate = default(int?), int? languagecode = default(int?), System.Guid? _modifiedonbehalfbyValue = default(System.Guid?), System.Guid? _owningbusinessunitValue = default(System.Guid?), System.Guid? _transactioncurrencyidValue = default(System.Guid?), bool? ismanaged = default(bool?), int? filesize = default(int?), System.Guid? mailmergetemplateidunique = default(System.Guid?), System.Guid? _owningteamValue = default(System.Guid?), int? statuscode = default(int?), string versionnumber = default(string), string mimetype = default(string), int? mailmergetype = default(int?), string iscustomizable = default(string), System.Guid? _owninguserValue = default(System.Guid?), System.Guid? _modifiedbyValue = default(System.Guid?), System.Guid? _createdonbehalfbyValue = default(System.Guid?), string body = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string filename = default(string), int? documentformat = default(int?), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), int? statecode = default(int?), System.Guid? solutionid = default(System.Guid?), decimal? exchangerate = default(decimal?), string introducedversion = default(string), bool? ispersonal = default(bool?), string description = default(string), System.Guid? mailmergetemplateid = default(System.Guid?), int? utcconversiontimezonecode = default(int?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string defaultfilter = default(string), string name = default(string), System.Guid? _owneridValue = default(System.Guid?), System.Guid? _createdbyValue = default(System.Guid?), string templatetypecode = default(string), string parameterxml = default(string), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), IList<MicrosoftDynamicsCRMasyncoperation> mailMergeTemplateAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsyncerror> mailMergeTemplateSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser))
        {
        ...
        public System.Guid? Mailmergetemplateidunique { get; set; }
        ...
        public System.Guid? Mailmergetemplateid { get; set; }
