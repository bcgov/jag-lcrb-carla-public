...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1
    {
        ...
        /// <param name="statecode">Status of the Application: Transfer
        /// Ownership v1</param>
        ...
        /// instance.</param>
        public MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1(string _createdbyValue = default(string), int? statuscode = default(int?), string versionnumber = default(string), string _createdonbehalfbyValue = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string bpfName = default(string), int? timezoneruleversionnumber = default(int?), string _bpfAdoxioApplicationidValue = default(string), string _modifiedbyValue = default(string), System.DateTimeOffset? completedon = default(System.DateTimeOffset?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), System.DateTimeOffset? activestagestartedon = default(System.DateTimeOffset?), string _processidValue = default(string), int? importsequencenumber = default(int?), string _organizationidValue = default(string), int? bpfDuration = default(int?), string _modifiedonbehalfbyValue = default(string), string businessprocessflowinstanceid = default(string), int? statecode = default(int?), string _activestageidValue = default(string), int? utcconversiontimezonecode = default(int?), string traversedpath = default(string), MicrosoftDynamicsCRMsystemuser createdbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), MicrosoftDynamicsCRMprocessstage activestageidname = default(MicrosoftDynamicsCRMprocessstage), MicrosoftDynamicsCRMworkflow processidname = default(MicrosoftDynamicsCRMworkflow), IList<MicrosoftDynamicsCRMsyncerror> adoxioApplicationtransferownershipv1SyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMasyncoperation> adoxioApplicationtransferownershipv1AsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMworkflowlog> adoxioApplicationtransferownershipv1WorkflowLogs = default(IList<MicrosoftDynamicsCRMworkflowlog>), IList<MicrosoftDynamicsCRMbulkdeletefailure> adoxioApplicationtransferownershipv1BulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), MicrosoftDynamicsCRMadoxioApplication bpfAdoxioApplicationid = default(MicrosoftDynamicsCRMadoxioApplication))
        {
        ...
        /// <summary>
        /// Gets or sets reason for the status of the Application: Transfer
        /// Ownership v1
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets status of the Application: Transfer Ownership v1
        /// </summary>
