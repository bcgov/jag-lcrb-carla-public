...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcolumnmapping
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMcolumnmapping(int? componentstate = default(int?), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), int? processcode = default(int?), string _modifiedbyValue = default(string), string sourceattributename = default(string), int? statuscode = default(int?), string solutionid = default(string), string columnmappingid = default(string), string _importmapidValue = default(string), string sourceentityname = default(string), string _modifiedonbehalfbyValue = default(string), int? statecode = default(int?), bool? ismanaged = default(bool?), string columnmappingidunique = default(string), string introducedversion = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string targetattributename = default(string), string _createdonbehalfbyValue = default(string), string targetentityname = default(string), string _createdbyValue = default(string), IList<MicrosoftDynamicsCRMpicklistmapping> pickListMappingColumnMapping = default(IList<MicrosoftDynamicsCRMpicklistmapping>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMimportmap importmapid = default(MicrosoftDynamicsCRMimportmap), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMlookupmapping> lookUpMappingColumnMapping = default(IList<MicrosoftDynamicsCRMlookupmapping>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser))
        {
