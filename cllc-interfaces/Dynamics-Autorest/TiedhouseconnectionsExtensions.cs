...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class TiedhouseconnectionsExtensions
    {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioTiedhouseconnectionCollection> GetAsync(this ITiedhouseconnections operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
