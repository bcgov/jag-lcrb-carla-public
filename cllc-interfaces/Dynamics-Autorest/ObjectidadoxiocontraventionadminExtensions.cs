...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiocontraventionadmin.
    /// </summary>
    public static partial class ObjectidadoxiocontraventionadminExtensions
    {
            /// <summary>
            /// Get objectid_adoxio_contraventionadmin from
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioContraventionadmin Get(this IObjectidadoxiocontraventionadmin operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioContraventionadmin> GetAsync(this IObjectidadoxiocontraventionadmin operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioContraventionadmin> GetWithHttpMessages(this IObjectidadoxiocontraventionadmin operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
