...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class Applicationbpfv3sExtensions
    {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationbpfv3> CreateWithHttpMessages(this IApplicationbpfv3s operations, MicrosoftDynamicsCRMadoxioApplicationbpfv3 body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationbpfv3> GetByKeyWithHttpMessages(this IApplicationbpfv3s operations, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse UpdateWithHttpMessages(this IApplicationbpfv3s operations, string businessprocessflowinstanceid, MicrosoftDynamicsCRMadoxioApplicationbpfv3 body, Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse DeleteWithHttpMessages(this IApplicationbpfv3s operations, string businessprocessflowinstanceid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
