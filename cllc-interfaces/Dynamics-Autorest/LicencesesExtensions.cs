...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public static partial class LicencesesExtensions
    {
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioLicencesCollection Get(this ILicenceses operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioLicencesCollection> GetWithHttpMessages(this ILicenceses operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
