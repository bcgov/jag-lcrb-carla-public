...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiospecialeventtandc.
    /// </summary>
    public static partial class ObjectidadoxiospecialeventtandcExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioSpecialeventtandc Get(this IObjectidadoxiospecialeventtandc operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
