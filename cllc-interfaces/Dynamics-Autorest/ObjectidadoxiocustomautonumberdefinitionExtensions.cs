...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Objectidadoxiocustomautonumberdefinition.
    /// </summary>
    public static partial class ObjectidadoxiocustomautonumberdefinitionExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioCustomautonumberdefinition Get(this IObjectidadoxiocustomautonumberdefinition operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioCustomautonumberdefinition> GetWithHttpMessages(this IObjectidadoxiocustomautonumberdefinition operations, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
