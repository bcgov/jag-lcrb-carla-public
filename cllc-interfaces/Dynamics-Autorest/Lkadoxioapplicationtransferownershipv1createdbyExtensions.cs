...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkadoxioapplicationtransferownershipv1createdby.
    /// </summary>
    public static partial class Lkadoxioapplicationtransferownershipv1createdbyExtensions
    {
            /// <summary>
            /// Get lk_adoxio_applicationtransferownershipv1_createdby from systemusers
            /// </summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1Collection Get(this ILkadoxioapplicationtransferownershipv1createdby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1 CreatedbyByKey(this ILkadoxioapplicationtransferownershipv1createdby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1> CreatedbyByKeyAsync(this ILkadoxioapplicationtransferownershipv1createdby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMadoxioApplicationtransferownershipv1> CreatedbyByKeyWithHttpMessages(this ILkadoxioapplicationtransferownershipv1createdby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
