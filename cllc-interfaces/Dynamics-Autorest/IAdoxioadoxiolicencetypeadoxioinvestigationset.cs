...
namespace Gov.Lclb.Cllb.Interfaces
{
    ...
    public partial interface IAdoxioadoxiolicencetypeadoxioinvestigationset
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> InvestigationsetByKey1WithHttpMessagesAsync(System.Guid adoxioAdoxioLicencetypeAdoxioInvestigationid, MicrosoftDynamicsCRMadoxioAdoxioLicencetypeAdoxioInvestigation body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete entity from
        ...
        /// Thrown when the operation returned an invalid status code
        /// </exception>
        Task<HttpOperationResponse> InvestigationsetByKey2WithHttpMessagesAsync(System.Guid adoxioAdoxioLicencetypeAdoxioInvestigationid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
