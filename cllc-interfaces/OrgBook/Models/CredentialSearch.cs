...
namespace Gov.Lclb.Cllb.Interfaces.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CredentialSearch class.
        /// </summary>
        ...
        public CredentialSearch(string walletId, CredentialSet credentialSet, CredentialType credentialType, IList<CredentialAddress> addresses, IList<CredentialAttribute> attributes, IList<CredentialName> names, CredentialTopic topic, IList<CredentialNamedTopic> relatedTopics, int? id = default(int?), System.DateTimeOffset? createTimestamp = default(System.DateTimeOffset?), System.DateTimeOffset? updateTimestamp = default(System.DateTimeOffset?), System.DateTimeOffset? effectiveDate = default(System.DateTimeOffset?), bool? inactive = default(bool?), bool? latest = default(bool?), bool? revoked = default(bool?), System.DateTimeOffset? revokedDate = default(System.DateTimeOffset?))
        {
            Id = id;
        ...
        public IList<CredentialAttribute> Attributes { get; set; }
        ...
        public CredentialTopic Topic { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (RelatedTopics != null)
            {
                foreach (var element3 in RelatedTopics)
                {
                    if (element3 != null)
                    {
                        element3.Validate();
