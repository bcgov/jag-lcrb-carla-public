...
namespace OoasUtil
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            if (processer.IsUrl)
            {
                generator = new UrlOpenApiGenerator(new Uri(processer.InputUri), processer.Output, processer.Target.Value);
            }
            else
            {
                generator = new FileOpenApiGenerator(processer.InputFile, processer.Output, processer.Target.Value);
            }
