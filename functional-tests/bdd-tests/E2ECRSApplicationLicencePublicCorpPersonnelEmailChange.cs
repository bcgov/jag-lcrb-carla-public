...
namespace bdd_tests
{
    [FeatureFile("./E2E_CRSApplication_Licence_publiccorp_personnel_email_change.feature")]
    public sealed class E2ECRSApplicationLicencePublicCorpPersonnelEmailChange : TestBase
    {
