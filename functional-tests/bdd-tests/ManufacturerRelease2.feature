...
#@manufacturer @winery @release 
#Scenario: UAT Manufacturer Release #1 (Winery/Private Corporation)
#    Given I am logged in to the dashboard as a private corporation
#    And I click on the Start Application button for a Manufacturer Licence
#    And I review the account profile for a private corporation
...
#@manufacturer @winery @release 
#Scenario: UAT Manufacturer Release #2 (Winery/Private Corporation)
#    Given I am logged in to the dashboard as a private corporation
#    And I click on the Start Application button for a Manufacturer Licence
#    And I review the account profile for a private corporation
#    And I review the organization structure for a private corporation
...
#@manufacturer @winery 
#Scenario: UAT Manufacturer Release #1 (Winery/Sole Proprietorship)
...
@manufacturer @winery 
#Scenario: UAT Manufacturer Release #2 (Winery/Sole Proprietorship)
#    Given I am logged in to the dashboard as a sole proprietorship
#    And I click on the Start Application button for a Manufacturer Licence
#    And I review the account profile for a sole proprietorship
#    And I review the organization structure for a sole proprietorship
