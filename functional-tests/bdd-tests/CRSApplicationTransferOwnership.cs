...
@e2e @cannabis @indigenousnation @crstransfer
...
@e2e @cannabis @publiccorporation @crstransfer
...
@e2e @cannabis @society @crstransfer
...
namespace bdd_tests
{
    [FeatureFile("./CRSApplicationTransferOwnership.feature")]
    public sealed class CRSApplicationTransferOwnership : TestBase
    {
