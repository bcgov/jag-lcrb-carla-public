...
/*
Feature: E2ECateringApplication_indigenous_nation_personnel_email_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a personnel email change for an indigenous nation
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_indigenous_nation_personnel_email_change.feature")]
    public sealed class E2ECateringApplicationLicenceIndigenousNationPersonnelEmailChange : TestBase
    {
