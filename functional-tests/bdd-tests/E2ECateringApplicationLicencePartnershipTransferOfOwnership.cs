...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_partnership_transfer_of_ownership.feature")]
    public sealed class E2ECateringApplicationLicencePartnershipTransferOfOwnership : TestBase
    {
