...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_sole_proprietor_event_authorization.feature")]
    public sealed class E2ECateringApplicationLicenceSoleProprietorEventAuthorization : TestBase
    {
