...
/*
Feature: E2ECateringApplication_society_transfer_of_ownership
    As a logged in business user
    I want to pay the first year catering licence fee
    And request a transfer of ownership for a society
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_transfer_of_ownership.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyTransferOfOwnership : TestBase
    {
