...
/*
Feature: E2ECateringApplication_society_name_branding_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a name branding change for a society
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_name_branding_change.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyNameBrandingChange : TestBase
    {
