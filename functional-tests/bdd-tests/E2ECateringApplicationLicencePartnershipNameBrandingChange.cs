...
/*
Feature: E2ECateringApplication_partnership_name_branding_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a name branding change for a partnership
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_partnership_name_branding_change.feature")]
    public sealed class E2ECateringApplicationLicencePartnershipNameBrandingChange : TestBase
    {
