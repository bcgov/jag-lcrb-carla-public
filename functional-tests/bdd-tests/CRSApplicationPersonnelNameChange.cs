...
/*
Feature: CRSApplicationPersonnelNameChange
...
namespace bdd_tests
{
    [FeatureFile("./CRSApplicationPersonnelNameChange.feature")]
    public sealed class CRSApplicationPersonnelNameChange : TestBase
    {
