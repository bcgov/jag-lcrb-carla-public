...
/*
Feature: E2ECateringApplication_society_third_party_operator
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a third party operator application for a society
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_third_party_operator.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyThirdPartyOperator : TestBase
    {
