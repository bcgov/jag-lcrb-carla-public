...
namespace bdd_tests
{
    [FeatureFile("./CRS_request_relocation.feature")]
    public sealed class CRSRequestRelocation : TestBase
    {
        [Given(@"the CRS application has been approved")]
        ...
        [And(@"I click on the Request Relocation link")]
        public void click_request_relocation()
        {
            /* 
            Page Title: 
            */
        ...
        [Then(@"a relocation request under review is displayed")]
        public void relocation_request_under_review()
        {
            /* 
            Page Title: Licences
