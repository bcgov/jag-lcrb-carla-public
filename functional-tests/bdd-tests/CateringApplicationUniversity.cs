...
/*
Feature: CateringApplication_university
    As a logged in business user
    I want to submit a Catering Application for a university
...
namespace bdd_tests
{
    [FeatureFile("./CateringApplication_university.feature")]
    public sealed class CateringApplicationUniversity : TestBase
    {        
