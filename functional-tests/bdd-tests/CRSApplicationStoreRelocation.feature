...
Scenario: DEV Cannabis Store Relocation (Society)
...
Scenario: DEV Cannabis Store Relocation (Partnership)
...
Scenario: DEV Cannabis Store Relocation (Sole Proprietorship)
