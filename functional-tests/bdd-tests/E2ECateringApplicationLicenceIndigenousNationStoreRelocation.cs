...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_indigenous_nation_store_relocation.feature")]
    public sealed class E2ECateringApplicationLicenceIndigenousNationStoreRelocation : TestBase
    {
