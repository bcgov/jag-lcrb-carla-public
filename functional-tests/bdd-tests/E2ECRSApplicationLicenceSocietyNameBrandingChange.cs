...
namespace bdd_tests
{
    [FeatureFile("./E2E_CRSApplication_Licence_society_name_branding_change.feature")]
    public sealed class E2ECRSApplicationLicenceSocietyNameBrandingChange : TestBase
    {
