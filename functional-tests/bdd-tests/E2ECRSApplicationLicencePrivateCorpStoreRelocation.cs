...
namespace bdd_tests
{
    [FeatureFile("./E2E_CRSApplication_Licence_privatecorp_store_relocation.feature")]
    public sealed class E2ECRSApplicationLicencePrivateCorpStoreRelocation : TestBase
    {
