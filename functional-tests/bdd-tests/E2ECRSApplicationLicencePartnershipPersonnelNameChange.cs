...
namespace bdd_tests
{
    [FeatureFile("./E2E_CRSApplication_Licence_partnership_personnel_name_change.feature")]
    public sealed class E2ECRSApplicationLicencePartnershipPersonnelNameChange : TestBase
    {
