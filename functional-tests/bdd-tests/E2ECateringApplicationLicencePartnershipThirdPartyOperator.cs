...
/*
Feature: E2ECateringApplication_partnership_third_party_operator
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a third party operator application for a partnership
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_partnership_third_party_operator.feature")]
    public sealed class E2ECateringApplicationLicencePartnershipThirdPartyOperator : TestBase
    {
