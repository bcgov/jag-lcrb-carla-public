...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_personnel_email_change.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyPersonnelEmailChange : TestBase
    {
