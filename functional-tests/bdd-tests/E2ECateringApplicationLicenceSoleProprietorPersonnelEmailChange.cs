...
/*
Feature: E2ECateringApplication_sole_proprietor_personnel_email_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a personnel email change for a sole proprietorship
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_sole_proprietor_personnel_email_change.feature")]
    public sealed class E2ECateringApplicationLicenceSoleProprietorPersonnelEmailChange : TestBase
    {
