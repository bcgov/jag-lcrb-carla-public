...
namespace bdd_tests
{
    [FeatureFile("./CRS_request_structural_change.feature")]
    public sealed class CRSRequestStructuralChange : TestBase
    {
        [Given(@"the CRS application has been approved")]
        ...
        [And(@"I click on the Request a Structural Change link")]
        public void click_request_structural_change()
        {
            /* 
            Page Title: 
            */
        ...
        [And(@"I submit a CRS structural change application")]
        public void submit_CRS_structure_change_application()
        {
            /* 
            Page Title: 
            */
