    ...
    public abstract partial class TestBase : Feature, IDisposable
    {
        ...
        protected TestBase()
        {
            ...
            if (!string.IsNullOrEmpty(configuration["OPENSHIFT_BUILD_COMMIT"]) || !string.IsNullOrEmpty(configuration["Build.BuildNumber"]))
            {
                ...
                options.AddArguments("headless", "no-sandbox", "disable-web-security", "no-zygote", "disable-gpu", "shm-size=1gb", "disable-infobars", "start-maximized", "hide-scrollbars", "--window-size=1920,1080");
