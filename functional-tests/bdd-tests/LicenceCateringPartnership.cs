...
/*
Feature: LicenceCatering_partnership
    As a logged in business user
    I want to pay the first year catering licence fee
    And complete the available application types for a partnership
...
namespace bdd_tests
{
    [FeatureFile("./LicenceCatering_partnership.feature")]
    public sealed class LicenceCateringPartnership : TestBase
    {
        [Given(@"the Catering application has been approved")]
