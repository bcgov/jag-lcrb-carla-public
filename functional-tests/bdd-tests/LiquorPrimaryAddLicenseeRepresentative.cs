...
/*
Feature: LiquorPrimaryAddLicenseeRepresentative
...
namespace bdd_tests
{
    [FeatureFile("./LiquorPrimaryAddLicenseeRepresentative.feature")]
    [Collection("Liquor")]
    public sealed class LiquorPrimaryAddLicenseeRepresentative : TestBase
    {
