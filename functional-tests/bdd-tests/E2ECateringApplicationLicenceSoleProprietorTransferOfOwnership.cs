...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_sole_proprietor_transfer_of_ownership.feature")]
    public sealed class E2ECateringApplicationLicenceSoleProprietorTransferOfOwnership : TestBase
    {
