...
/*
Feature: LiquorPrimaryChangeHours
    As a logged in business user
    I want to request a change of hours for a Liquor Primary Application

@liquorprimary
Scenario: Liquor Primary Change Hours (Private Corporation)
...
namespace bdd_tests
{
    [FeatureFile("./LiquorPrimaryChangeHours.feature")]
    [Collection("Liquor")]
    public sealed class LiquorPrimaryChangeHours : TestBase
    {
