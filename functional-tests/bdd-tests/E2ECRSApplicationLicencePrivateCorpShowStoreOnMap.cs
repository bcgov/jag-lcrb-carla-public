...
namespace bdd_tests
{
    [FeatureFile("./E2E_CRSApplication_Licence_privatecorp_show_store_on_map.feature")]
    public sealed class E2ECRSApplicationLicencePrivateCorpShowStoreOnMap : TestBase
    {
