...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_sole_proprietor_third_party_operator.feature")]
    public sealed class E2ECateringApplicationLicenceSoleProprietorThirdPartyOperator : TestBase
    {
