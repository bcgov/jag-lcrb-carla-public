...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_public_corp_store_relocation.feature")]
    public sealed class E2ECateringApplicationLicencePublicCorpStoreRelocation : TestBase
    {
