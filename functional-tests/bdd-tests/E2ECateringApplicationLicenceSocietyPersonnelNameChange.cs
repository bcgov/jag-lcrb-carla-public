...
/*
Feature: E2ECateringApplication_society_personnel_name_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a personnel name change for a society
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_personnel_name_change.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyPersonnelNameChange : TestBase
    {
