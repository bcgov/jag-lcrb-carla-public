...
/*
Feature: E2ECateringApplication_society_store_relocation
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a store relocation request for a society
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_society_store_relocation.feature")]
    public sealed class E2ECateringApplicationLicenceSocietyStoreRelocation : TestBase
    {
