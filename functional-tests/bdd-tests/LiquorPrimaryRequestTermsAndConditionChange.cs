...
/*
Feature: LiquorPrimaryRequestTermsAndConditionChange
...
namespace bdd_tests
{
    [FeatureFile("./LiquorPrimaryRequestTermsAndConditionChange.feature")]
    [Collection("Liquor")]
    public sealed class LiquorPrimaryRequestTermsAndConditionChange : TestBase
    {
