...
/*
Feature: E2ECateringApplication_sole_proprietor_name_branding_change
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a name branding change for a sole proprietorship
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_sole_proprietor_name_branding_change.feature")]
    public sealed class E2ECateringApplicationLicenceSoleProprietorNameBrandingChange : TestBase
    {
