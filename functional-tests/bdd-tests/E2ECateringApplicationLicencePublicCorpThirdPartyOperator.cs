...
/*
Feature: E2ECateringApplication_public_corp_third_party_operator
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit a third party operator application for a public corporation
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_public_corp_third_party_operator.feature")]
    public sealed class E2ECateringApplicationLicencePublicCorpThirdPartyOperator : TestBase
    {
