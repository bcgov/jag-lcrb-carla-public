...
namespace bdd_tests
{
    [FeatureFile("./Catering_request_name_branding_change.feature")]
    public sealed class CateringLicenceRequestNameBrandingChange : TestBase
    {
        [Given(@"the Catering application has been approved")]
        ...
        [And(@"I click on the Request Store Name or Branding Change link")]
        public void name_branding_change_link()
        {
            /* 
            Page Title: 
            */
        ...
        [And(@"I submit a valid name or branding change application")]
        public void submit_name_branding_application()
        {
            /* 
            Page Title: 
            */
        ...
        [Then(@"a name or branding change application under review is displayed")]
        public void name_branding_change_displayed()
        {
            /* 
            Page Title: 
            */
