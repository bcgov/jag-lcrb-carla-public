...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_partnership_personnel_name_change.feature")]
    public sealed class E2ECateringApplicationLicencePartnershipPersonnelNameChange : TestBase
    {
