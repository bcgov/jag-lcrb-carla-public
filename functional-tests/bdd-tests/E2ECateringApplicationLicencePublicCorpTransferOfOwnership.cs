...
/*
Feature: E2ECateringApplication_public_corp_transfer_of_ownership
    As a logged in business user
    I want to pay the first year catering licence fee
    And request a transfer of ownership for a public corporation
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_public_corp_transfer_of_ownership.feature")]
    public sealed class E2ECateringApplicationLicencePublicCorpTransferOfOwnership : TestBase
    {
