...
/*
Feature: E2ECateringApplication_indigenous_nation_event_authorization
    As a logged in business user
    I want to pay the first year catering licence fee
    And submit an event authorization request for an indigenous nation
...
namespace bdd_tests
{
    [FeatureFile("./E2ECateringApplication_indigenous_nation_event_authorization.feature")]
    public sealed class E2ECateringApplicationLicenceIndigenousNationEventAuthorization : TestBase
    {
