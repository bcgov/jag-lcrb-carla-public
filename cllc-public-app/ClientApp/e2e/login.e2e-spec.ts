...
describe("Login component test",
  () => {
    ...
    it("should login and populate the business profile",
      async () => {
        ...
        expect(page.getHeading("h2"))
          .toEqual("Please confirm the business or organization name associated to the Business BCeID.");


        element(by.css(".btn-primary.confirmYes")).click();
        expect(page.getHeading("h2"))
          .toEqual("Please confirm the organization type associated with the Business BCeID:");
        page.getPrivateCorpRadio().click();
        page.getButtonByClass("btn-primary").click();
        page.getButtonByClass("btn-primary").click();
        ...
        browser.actions()
          .mouseMove(element(by.css('[formcontrolname="federalProducerConnectionToCorp"][ng-reflect-value="1"]')))
          .perform();
