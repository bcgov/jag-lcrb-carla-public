  ...
  () => {
    ...
    it("should load the survey configuration file",
      async () => {
        ...
        expect(surveyConfig.pages[0].elements[0].title)
          .toEqual("Is the person who will fill out and submit the application 19 years old or older?");
