...
// Section 2
export function reducer(state: OnGoingLicenseeChangesApplicationIdState = initialState,
  action: OngoingLicenseeApplicationIdActions.Actions): OnGoingLicenseeChangesApplicationIdState {
