...
export class FederalReportingComponent implements OnInit {
  ...
  ngOnInit() {
    this.busy = forkJoin([
      ...
      .subscribe(results => {
        this.licenses = results[0].filter(l => l.licenceTypeName === "Cannabis Retail Store" || l.licenceTypeName === "Section 119 Authorization" || l.licenceTypeName === "Production Retail Store");
