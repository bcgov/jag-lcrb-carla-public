...
import { CRS_RENEWAL_LICENCE_TYPE_NAME, LIQOR_RENEWAL_LICENCE_TYPE_NAME } from '../licences.component';
...
export class LicenceRenewalStepsComponent implements OnInit {
  ...
  LIQOR_RENEWAL_LICENCE_TYPE_NAME = LIQOR_RENEWAL_LICENCE_TYPE_NAME;
