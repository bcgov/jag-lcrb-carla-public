...
import { CancelThirdPartyOperatorComponent } from "./cancel-third-party-operator.component";
...
describe("ApplicationCancelOwnershipTransferComponent",
  () => {
    let component: CancelThirdPartyOperatorComponent;
    let fixture: ComponentFixture<CancelThirdPartyOperatorComponent>;
    ...
    beforeEach(waitForAsync(() => {
      ...
      TestBed.configureTestingModule({
          declarations: [CancelThirdPartyOperatorComponent, FieldComponent],
          imports: [
            RouterTestingModule,
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(CancelThirdPartyOperatorComponent);
