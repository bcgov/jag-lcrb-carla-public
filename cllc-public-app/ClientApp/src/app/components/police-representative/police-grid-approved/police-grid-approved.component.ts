...
@Component({
  selector: 'app-police-grid-approved',
  templateUrl: './police-grid-approved.component.html',
  styleUrls: ['./police-grid-approved.component.scss']
})
export class PoliceGridApprovedComponent implements OnInit {
  resultsLength = 0;
    ...
    merge(this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.sepDataService.getPoliceApprovedSepApplications(this.paginator.pageIndex, this.paginator.pageSize, this.dataSource.sort.active, this.dataSource.sort.direction);
        }),
        map(result => {
