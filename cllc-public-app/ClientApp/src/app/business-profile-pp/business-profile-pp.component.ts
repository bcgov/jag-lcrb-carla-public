...
@Component({
  selector: 'app-business-profile-pp',
  templateUrl: './business-profile-pp.component.html',
  styleUrls: ['./business-profile-pp.component.scss']
})
export class BusinessProfilePpComponent extends FormBase implements OnInit {
  currentUser: User;
  dataLoaded = false;
  busy: Promise<any>;
  busy2: Promise<any>;
