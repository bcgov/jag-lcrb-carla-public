...
namespace Gov.Lclb.Cllb.Public.Seeders
{
    public class RoleSeeder : Seeder<AppDbContext>
    {
        ...
        public RoleSeeder(IConfiguration configuration, IHostingEnvironment env, ILoggerFactory loggerFactory, Gov.Lclb.Cllb.Interfaces.Microsoft.Dynamics.CRM.System system, IDistributedCache distributedCache) 
