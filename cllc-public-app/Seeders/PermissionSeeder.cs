...
namespace Gov.Lclb.Cllb.Public.Seeders
{
    internal class PermissionSeeder : Seeder<AppDbContext>
    {
        ...
        public PermissionSeeder(IConfiguration configuration, IHostingEnvironment env, ILoggerFactory loggerFactory, Gov.Lclb.Cllb.Public.Contexts.Microsoft.Dynamics.CRM.System system, IDistributedCache distributedCache) 
