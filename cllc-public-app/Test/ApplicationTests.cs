...
namespace Gov.Lclb.Cllb.Public.Test
{
	public class ApplicationTests : ApiIntegrationTestBaseWithLogin
    {
        ...
        public async System.Threading.Tasks.Task TestCRUD()
        {
			...
			Gov.Lclb.Cllb.Public.Contexts.Microsoft.Dynamics.CRM.Adoxio_application application = new Gov.Lclb.Cllb.Public.Contexts.Microsoft.Dynamics.CRM.Adoxio_application()
            {
